...
var UserComponent = (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        this.userFrm = this.fb.group({
            'Id': [''],
            'FirstName': ['', [forms_1.Validators.required, forms_1.Validators.minLength(2), forms_1.Validators.maxLength(20)]],
            'LastName': [''],
            'Email': ['', [forms_1.Validators.required, validation_service_1.ValidationService.emailValidator]],
            'PhoneNumber': ['', [forms_1.Validators.required, validation_service_1.ValidationService.phoneNumberValidator]],
    ...
    UserComponent.prototype.LoadUsers = function () {
        ...
        this._userService.get(global_1.Global.BASE_USER_ENDPOINT)
            .subscribe(function (users) { _this.setUsers(users); _this.indLoading = false; }, function (error) { return _this.msg = error; });
    };
    ...
    UserComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._userService.post(global_1.Global.BASE_USER_ENDPOINT, this.getUpdatedFormData(formData._value)).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                this._userService.put(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id, this.getUpdatedFormData(formData._value)).subscribe(function (data) {
                    if (data == 1) {
    ...
    UserComponent.prototype.setUsers = function (users) {
        users.forEach(function (x) {
            x.Status ? x.Status = 'Active' : x.Status = 'Inactive';
        });
        this.users = users;
    };
    UserComponent.prototype.getUpdatedFormData = function (formData) {
